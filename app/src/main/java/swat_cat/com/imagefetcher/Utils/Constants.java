...
public class Constants {
    ...
    public final static String IMAGE_SIZE = "medium";
    public final static String SEARCH_TYPE = "image";
    public final static String JSON_PATH_BASE = "$.items[*].";
    //URL url = new URL("https://www.googleapis.com/customsearch/v1?key=" +GOOGLE_API_KEY+ "&amp;cx=" +ENGINE_API+ "&amp;q=" +qry+"&amp;fileType="+FILE_TYPE+"&amp;searchType="+SEARCH_TYPE+"&amp;alt=json");
}
